...
controller.set_params(np.diag([1200,1200,1200,0,0,0]),np.diag([1,1,1,1,1,1,1,1,1]))
...
while viewer.is_running():
    ...
    launch_mapping = {
        "start_0":np.array([0,-40,70,0,0,0]),
        "start_1":np.array([0,40,70,0,0,0]),
        "start_2":np.array([-40,0,70,0,0,0]),
        "start_3":np.array([40,0,70,0,0,0]),
        "start_4":np.array([-30,-30,70,0,0,0]),
        "start_5":np.array([30,-30,70,0,0,0]),
        "start_6":np.array([-30,30,70,0,0,0]),
        "start_7":np.array([30,30,70,0,0,0])
    }
